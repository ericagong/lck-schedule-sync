...
4. [ICS 출력 — METHOD:PUBLISH + UID 멱등성](#4-ics-출력--methodpublish--uid-멱등성)
...
**선택**: bestOf 기준 추정 — Bo1=+1h, Bo3=+3h, Bo5=+4.5h.
...
- VTIMEZONE Asia/Seoul 블록 명시 (Apple·Outlook 호환 안정성)
- CRLF 줄바꿈
...
- **policy.ts → league/team/match/naver/ics 모듈 분리** — 도메인 경계를 코드에도 명시 (최근 refactor).
